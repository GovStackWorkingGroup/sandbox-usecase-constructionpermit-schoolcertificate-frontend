    ...
    <>
      ...
      >
        <Heading as="h1" size="md" variant="display">
          {t('inquiry.payment.successful.title')}
        </Heading>
        <Text>
          {t('inquiry.payment.successful.desc1')}
          <br />
          <br />
          {t('inquiry.payment.successful.allow')}{" "}
          <span style={{ fontWeight: "bold", color: colors.theme.primary }}>
            {t('inquiry.payment.successful.desc2')}
          </span>{" "}
          {t('inquiry.payment.successful.desc2')}
          <br />
          <br />
          {t('inquiry.payment.successful.thank-you')}
        </Text>
        <Button
          variant="link"
          colorScheme="admin"
